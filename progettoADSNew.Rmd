...
Centralizzazione del grado: misura che valuta quanto una rete è centralizzata in base alla distribuzione del grado dei nodi. Vi sono alcuni nodi con un numero di collegamenti significativamente maggiore rispetto alla maggior parte degli altri nodi, ma la distribuzione dei gradi non è uguale.
...
SCRIVERE EFFETTIVAMENTE COSA HO RICAVATO DALLE PREMESSE INIZIALI + LE COSE IN PIU

TUTTE LE RETI HANNO LA PROPRIETà PICCOLO MONDO
