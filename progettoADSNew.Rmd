...
Utilizzando la libreria poweRlaw [@poweRlaw], è possibile controllare se la distribuzione dei gradi segue una distribuzione power-law.
...
Il p-value di `r bs_p2$p` indica che i dati sono compatibili con la distribuzione power-law, con pochi nodi altamente connessi (hub) e molti nodi con poche connessioni.
...
Il p-value di `r bs_p$p` indica che i dati sono compatibili con la distribuzione power-law, con pochi nodi altamente connessi (hub) e molti nodi con poche connessioni.
